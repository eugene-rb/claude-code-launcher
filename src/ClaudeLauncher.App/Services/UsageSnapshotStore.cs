...
/// <summary>Persists <see cref="UsageSnapshot"/> as JSON under %APPDATA%\ClaudeLauncher, mirroring
...
public sealed class UsageSnapshotStore
{
    ...
    public UsageSnapshotStore()
        : this(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "ClaudeLauncher", "usage-snapshot.json"))
    {
    }
