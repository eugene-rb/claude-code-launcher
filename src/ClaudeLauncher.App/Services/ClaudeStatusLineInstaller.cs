...
/// round-trip untouched. A one-time <c>.bak-claudelauncher-*</c> copy is taken before the first write,
...
public sealed class ClaudeStatusLineInstaller
{
    ...
    private void BackupOnce()
    {
        ...
        var backupPath = _settingsPath + $".bak-claudelauncher-{DateTimeOffset.Now:yyyyMMdd}";
