...
/// <summary>Persists <see cref="UsageCalibration"/> as JSON under %APPDATA%\SmoothCoder, mirroring
...
public sealed class UsageCalibrationStore
{
    ...
    public UsageCalibrationStore()
        : this(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Smooth-Coder", "usage-calibration.json"))
    {
    }
