...
{
    private const string SingleInstanceMutexName = "Local\\SmoothCoder-SingleInstance";
    private const string ShowRequestEventName = "Local\\SmoothCoder-ShowRequest";
